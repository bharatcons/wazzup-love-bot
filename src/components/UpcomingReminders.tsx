  ...
  return (
    <Card className="mb-8">
      <CardHeader className="pb-3">
        <CardTitle className="text-md font-medium">Upcoming Reminders</CardTitle>
      </CardHeader>
      <CardContent>
          ...
          {sortedReminders.map(reminder => (
            ...
            >
              <div className="flex items-center space-x-3">
                <div className={`flex items-center justify-center w-10 h-10 rounded-full bg-whatsapp-light/10 ${
                ...
                <div>
                  ...
                  <div className="flex items-center text-sm text-muted-foreground">
                    ...
                    <span>{reminder.message.length > 20 
              ...
              <div className="flex items-center space-x-2">
                <div className="text-right mr-2">
                  <p className="text-sm font-medium">{reminder.nextTime && formatReminderTime({
                ...
                <Button 
                  size="sm" 
                  className="bg-whatsapp hover:bg-whatsapp-dark h-8 w-8 p-0"
                  onClick={() => window.open(getWhatsAppLink(reminder.phoneNumber), '_blank')}
                >
