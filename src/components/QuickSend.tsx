...
import { AlertCircle, MessageCircle, Phone, Send, Users, Sparkles } from 'lucide-react';
...
const QuickSend: React.FC = () => {
  ...
  const { contacts, markContactAsUsed } = useContacts();
  ...
  return (
    <Card className="w-full">
      <CardHeader className="pb-2 md:pb-4">
        <CardTitle className="text-md md:text-lg">Quick Send</CardTitle>
        <CardDescription>
          Send a WhatsApp message without creating a reminder
        </CardDescription>
      </CardHeader>
      <CardContent>
